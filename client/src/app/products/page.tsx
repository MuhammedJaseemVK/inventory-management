        ...
        {isLoading ? (
          ...
          products.map((product) => (
            <div
              ...
              className="border border-shadow dark:border-white rounded-md p-4 max-w-full w-full mx-auto"
            >
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-800 dark:text-gray-100">${product.price.toFixed(2)}</p>
